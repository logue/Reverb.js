...
window.addEventListener('load', async () => {
  ...
  document.getElementById('freq')?.addEventListener('change', e => {
    const target = e.target as HTMLInputElement;
    reverb.filterFreq(Number.parseInt(target.value));
    target.title = target.value;
  });
  // Filter quality
  document.getElementById('q')?.addEventListener('change', e => {
    const target = e.target as HTMLInputElement;
    reverb.filterQ(Number.parseInt(target.value));
    target.title = target.value;
  });
  // Dry/Wet
  document.getElementById('mix')?.addEventListener('change', e => {
    const target = e.target as HTMLInputElement;
    reverb.mix(Number.parseInt(target.value));
    target.title = target.value;
  });
  // Noise Type
  ...
  document.getElementById('peaks')?.addEventListener('change', e => {
    const target = e.target as HTMLInputElement;
    reverb.peaks(Number.parseInt(target.value));
    target.title = target.value;
  });
  document.getElementById('scale')?.addEventListener('change', e => {
    const target = e.target as HTMLInputElement;
    reverb.scale(Number.parseInt(target.value));
    target.title = target.value;
  });
